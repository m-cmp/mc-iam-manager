...
See [the Code documentation]({% link docs/wiki/docs/ui-components/code.md %}#mermaid-diagram-code-blocks) for more configuration options and information.
...
See [Navigation Structure]({% link docs/wiki/docs/navigation-structure.md %}#external-navigation-links) for more details.
...
See [Customization]({% link docs/wiki/docs/customization.md %}) for more information.
...
See [Callouts]({% link docs/wiki/docs/ui-components/callouts.md %}) for more information.
